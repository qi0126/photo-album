...
function winonload(){
	http.getAjax_clean("/photo-album/customer/get_user", function(data) {
		...
		for(var i=0;i<data.length;i++){
			customer_manage_html+='<li id="id-'+data[i].userid+'"><input id="'+data[i].userid+'" name="select_userid_checkbox" type="checkbox" style="float:left;margin:18px 0 0 30px;"/><button class="select_userid_btn" onclick="selectuserid(\''+data[i].userid+'\')">'+data[i].userid+'</button></li>';
		}
...
function customer_submit(){
	if(($("#userid").val()).length != 0){
		...
		post_data.append('creditline', $("#creditline").val());
	...
	http.getAjax_clean("/photo-album/customer/get_user", function(data) {
		...
		for(var i=0;i<data.length;i++){
			if(elem ==data[i].userid){
				...
				$("#creditline").val(data[i].creditline);
